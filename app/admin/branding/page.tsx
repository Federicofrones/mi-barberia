        ...
        <div className="space-y-12 max-w-5xl pb-20">
            ...
            <div className="flex justify-center pt-8 border-t border-white/5">
                <Button
                    onClick={handleSave}
                    disabled={saving}
                    className="w-full md:w-auto bg-[#D4AF37] text-black px-16 py-6 font-black uppercase text-sm tracking-widest shadow-2xl shadow-[#D4AF37]/30 hover:scale-[1.02] active:scale-[0.98] transition-all rounded-[1.5rem]"
                >
                    {saving ? 'Procesando cambios...' : <><Save className="w-5 h-5 mr-3" /> Guardar Identidad de Marca</>}
                </Button>
            </div>
        </div>
    );
